...
public class ReadFactory {
	public static <T> String read(HashSet<String> words, String path, Filter bad_simbols, Filter bad_words){
		String status = "+";
	...
	public static <T> String read(HashMap<String, String> words, String path, Filter bad_simbols, Filter bad_words){	
		String status = "+";
		try(FileReader reader = new FileReader(path)){
			int c;
			String word = new String();
